...
ALTER TABLE sonde.sonde_data ADD COLUMN parent_upload_id text;
...
ALTER TABLE dgt.dgt_data ADD COLUMN parent_upload_id text;
...
ALTER TABLE pmd.pmd_data ADD COLUMN parent_upload_id text;
...
ALTER TABLE grab.grab_data ADD COLUMN parent_upload_id text;
