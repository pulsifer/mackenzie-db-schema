...
ALTER TABLE sonde.sonde_data ADD COLUMN parent_upload_id text NOT NULL;
...
ALTER TABLE sonde.sonde_meta ADD COLUMN description text;ALTER TABLE dgt.dgt_data DROP CONSTRAINT dgt_data_pkey;
ALTER TABLE dgt.dgt_data ADD COLUMN upload_id text NOT NULL;
ALTER TABLE dgt.dgt_data ADD COLUMN parent_upload_id text NOT NULL;
...
ALTER TABLE dgt.dgt_meta ADD COLUMN description text;ALTER TABLE pmd.pmd_data DROP CONSTRAINT pmd_data_pkey;
ALTER TABLE pmd.pmd_data ADD COLUMN upload_id text NOT NULL;
ALTER TABLE pmd.pmd_data ADD COLUMN parent_upload_id text NOT NULL;
...
ALTER TABLE pmd.pmd_meta ADD COLUMN description text;ALTER TABLE grab.grab_data DROP CONSTRAINT grab_data_pkey;
ALTER TABLE grab.grab_data ADD COLUMN upload_id text NOT NULL;
ALTER TABLE grab.grab_data ADD COLUMN parent_upload_id text NOT NULL;
